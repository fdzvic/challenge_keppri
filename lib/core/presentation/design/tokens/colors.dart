...
class CustomColors {
  final Color primaryColor = const Color(0xFF10121F);
  final Color backgroundColor = const Color(0xFF10121F);
  final Color textColor = const Color(0xFFFFFFFF);
  final Color textColor2 = const Color(0xFF161621);
  final Color disabledTextColor = const Color(0xFF919191);
